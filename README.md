...
The module contains an English, German and Chinese (thanks to [feederze](https://github.com/feederze)) translation. If you want additional languages to be supported [let me know](https://github.com/Saibot393/Rideable/issues).
